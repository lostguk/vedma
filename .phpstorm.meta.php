...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'app.frontend_verify_path' => 'string',
            ...
            'scribe.form_requests.enabled' => 'boolean',
            'scribe.form_requests.rules' => 'array',
            'scribe.form_requests.skip' => 'array',
            ...
            'services.metaship.api_key' => 'string',
            'services.metaship.api_secret' => 'string',
            'services.metaship.shop_id' => 'string',
            'services.metaship.warehouse_id' => 'string',
            'services.alfabank.base_url' => 'string',
            'services.alfabank.username' => 'string',
            'services.alfabank.password' => 'string',
            'services.alfabank.return_url' => 'string',
            'services.alfabank.fail_url' => 'string',
            'services.alfabank.language' => 'string',
            'services.alfabank.currency' => 'string',
            'services.dadata.token' => 'string',
            'services.dadata.address_suggest_url' => 'string',
...
'app.aliases.Vite','app.frontend_verify_path','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
...
'filament.livewire_loading_delay','filament.system_route_prefix','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root',
...
'ide-helper.additional_relation_return_types','ide-helper.enforce_nullable_relationships','ide-helper.post_migrate','ide-helper.macroable_traits','livewire.class_namespace',
...
'logging.channels.emergency.path','logging.channels.api.driver','logging.channels.api.path','logging.channels.api.level','logging.channels.api.days',
'logging.channels.api.replace_placeholders','logging.channels.performance.driver','logging.channels.performance.path','logging.channels.performance.level','logging.channels.performance.days',
'logging.channels.performance.replace_placeholders','logging.channels.errors.driver','logging.channels.errors.path','logging.channels.errors.level','logging.channels.errors.days',
'logging.channels.errors.replace_placeholders','logging.channels.browser.driver','logging.channels.browser.path','logging.channels.browser.level','logging.channels.browser.days',
'mail.default','mail.mailers.smtp.transport','mail.mailers.smtp.scheme','mail.mailers.smtp.url','mail.mailers.smtp.host',
'mail.mailers.smtp.encryption','mail.mailers.smtp.port','mail.mailers.smtp.username','mail.mailers.smtp.password','mail.mailers.smtp.timeout',
...
'scribe.auth.extra_info','scribe.intro_text','scribe.example_languages','scribe.postman.enabled','scribe.postman.overrides',
'scribe.openapi.enabled','scribe.openapi.overrides','scribe.openapi.generators','scribe.groups.default','scribe.groups.order',
'scribe.logo','scribe.last_updated','scribe.examples.faker_seed','scribe.examples.models_source','scribe.strategies.metadata',
'scribe.strategies.headers','scribe.strategies.headers.2.1.only','scribe.strategies.headers.2.1.except','scribe.strategies.headers.2.1.data.Content-Type','scribe.strategies.headers.2.1.data.Accept',
'scribe.strategies.urlParameters','scribe.strategies.queryParameters','scribe.strategies.bodyParameters','scribe.strategies.responses','scribe.strategies.responses.5.1.only',
'scribe.strategies.responses.5.1.except','scribe.strategies.responses.5.1.config.app.debug','scribe.strategies.responses.5.1.queryParams','scribe.strategies.responses.5.1.bodyParams','scribe.strategies.responses.5.1.fileParams',
'scribe.strategies.responses.5.1.cookies','scribe.strategies.responseFields','scribe.database_connections_to_transact','scribe.fractal.serializer','scribe.form_requests.enabled',
'scribe.form_requests.rules','scribe.form_requests.skip','services.postmark.token','services.ses.key','services.ses.secret',
'services.ses.region','services.resend.key','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.metaship.api_key',
'services.metaship.api_secret','services.metaship.shop_id','services.metaship.warehouse_id','services.alfabank.base_url','services.alfabank.username',
'services.alfabank.password','services.alfabank.return_url','services.alfabank.fail_url','services.alfabank.language','services.alfabank.currency',
'services.dadata.token','services.dadata.address_suggest_url','session.driver','session.lifetime','session.expire_on_close',
...
'blade-icons.components.default','boost.enabled','boost.browser_logs_watcher','tinker.commands','tinker.alias',
'tinker.dont_alias',);
...
'filament.admin.pages.dashboard','filament.admin.resources.categories.index','filament.admin.resources.categories.create','filament.admin.resources.categories.edit','filament.admin.resources.home-page-contents.index',
'filament.admin.resources.home-page-contents.edit','filament.admin.resources.orders.index','filament.admin.resources.orders.create','filament.admin.resources.orders.edit','filament.admin.resources.pages.index',
'filament.admin.resources.pages.create','filament.admin.resources.pages.edit','filament.admin.resources.products.index','filament.admin.resources.products.create','filament.admin.resources.products.edit',
'filament.admin.resources.promo-codes.index','filament.admin.resources.promo-codes.create','filament.admin.resources.promo-codes.edit','filament.admin.resources.topics.index','filament.admin.resources.topics.create',
'filament.admin.resources.topics.edit','filament.admin.resources.users.index','filament.admin.resources.users.create','filament.admin.resources.users.edit','scribe',
'scribe.postman','scribe.openapi','boost.browser-logs','sanctum.csrf-cookie','livewire.update','livewire.upload-file','livewire.preview-file','api.v1.health','api.v1.auth.register',
'api.v1.auth.login','api.v1.auth.forgot-password','api.v1.auth.reset-password','api.v1.auth.logout','api.v1.auth.change-password',
'api.v1.auth.verify-registration','api.v1.auth.verify-registration.resend','user.profileshow','user.profileupdate','user.topics.index',
'user.topics.store','user.topics.unread-count','user.topics.show','user.topics.messages.store','api.v1.order.calculate',
'api.v1.orders.index','api.v1.order.store','api.v1.order.address.suggest','api.v1.payments.store','api.v1.payments.status',
'api.v1.payments.refund','api.v1.payments.alfabank.webhook','api.v1.categories.index','api.v1.categories.show','api.v1.products.show',
'api.v1.products.index','mail.test','pages.index','pages.show','api.v1.shipping.calculate',
'api.v1.home.show','verification.verify','storage.local',);
        registerArgumentsSet('views', 
'components.filament.user-menu-header','emails.auth.reset-password','emails.test','filament.components.user-name','notifications::email',
'scribe.index','vendor.notifications.email','welcome','filament-actions::badge-action','filament-actions::badge-group',
...
'validation.uuid','validation.custom.attribute-name.rule-name','filament.actions.edit.label','filament.actions.delete.label','filament-actions::associate.single.label',
...
'LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL','APP_PORT','FORWARD_DB_PORT','FORWARD_REDIS_PORT',
'VITE_PORT','WWWUSER','WWWGROUP','DB_CONNECTION','DB_HOST',
...
'FILESYSTEM_DISK','QUEUE_CONNECTION','CACHE_STORE','CACHE_PREFIX','REDIS_CLIENT',
'REDIS_HOST','REDIS_PASSWORD','REDIS_PORT','REDIS_DB','MAIL_MAILER',
'MAIL_HOST','MAIL_PORT','MAIL_USERNAME','MAIL_PASSWORD','MAIL_ENCRYPTION',
'MAIL_FROM_ADDRESS','MAIL_FROM_NAME','MAIL_LOG_CHANNEL','AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY',
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','TELESCOPE_ENABLED',
'TELESCOPE_DRIVER','TELESCOPE_PATH','TELESCOPE_CACHE_WATCHER','TELESCOPE_COMMAND_WATCHER','TELESCOPE_DUMP_WATCHER',
'TELESCOPE_EVENT_WATCHER','TELESCOPE_EXCEPTION_WATCHER','TELESCOPE_JOB_WATCHER','TELESCOPE_LOG_WATCHER','TELESCOPE_MAIL_WATCHER',
'TELESCOPE_MODEL_WATCHER','TELESCOPE_NOTIFICATION_WATCHER','TELESCOPE_QUERY_WATCHER','TELESCOPE_REDIS_WATCHER','TELESCOPE_REQUEST_WATCHER',
'TELESCOPE_SCHEDULE_WATCHER','TELESCOPE_VIEW_WATCHER','L5_SWAGGER_GENERATE_ALWAYS','METASHIP_API_KEY','METASHIP_API_SECRET',
'METASHIP_SHOP_ID','METASHIP_WAREHOUSE_ID','ALFABANK_BASE_URL','ALFABANK_USERNAME','ALFABANK_PASSWORD',
'ALFABANK_RETURN_URL','ALFABANK_FAIL_URL','ALFABANK_LANGUAGE','ALFABANK_CURRENCY','DADATA_API_KEY',);
