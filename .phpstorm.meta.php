...
'filament.admin.resources.promo-codes.edit','filament.admin.resources.users.index','filament.admin.resources.users.create','filament.admin.resources.users.edit','scribe',
'scribe.postman','scribe.openapi','sanctum.csrf-cookie','livewire.update','livewire.upload-file','livewire.preview-file','api.v1.auth.register','api.v1.auth.login','api.v1.auth.logout',
'api.v1.auth.change-password','api.v1.categories.index','api.v1.categories.show','api.v1.products.show','api.v1.products.index',
'mail.test','pages.index','pages.show','api.v1.order.calculate','api.v1.order.store',
'user.profile','user.profile.update','storage.local',);
        registerArgumentsSet('views', 
'components.filament.user-menu-header','emails.test','filament.components.user-name','scribe.index','welcome',
...
'scribe::themes.elements.sidebar','scribe::themes.elements.try_it_out',);
...
'MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','MAIL_LOG_CHANNEL','AWS_ACCESS_KEY_ID',
'AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME',
'TELESCOPE_ENABLED','TELESCOPE_DRIVER','TELESCOPE_PATH','TELESCOPE_CACHE_WATCHER','TELESCOPE_COMMAND_WATCHER',
'TELESCOPE_DUMP_WATCHER','TELESCOPE_EVENT_WATCHER','TELESCOPE_EXCEPTION_WATCHER','TELESCOPE_JOB_WATCHER','TELESCOPE_LOG_WATCHER',
'TELESCOPE_MAIL_WATCHER','TELESCOPE_MODEL_WATCHER','TELESCOPE_NOTIFICATION_WATCHER','TELESCOPE_QUERY_WATCHER','TELESCOPE_REDIS_WATCHER',
'TELESCOPE_REQUEST_WATCHER','TELESCOPE_SCHEDULE_WATCHER','TELESCOPE_VIEW_WATCHER','TELESCOPE_DB_CONNECTION','L5_SWAGGER_GENERATE_ALWAYS',);
