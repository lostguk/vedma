...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'logging.channels.performance.driver' => 'string',
            'logging.channels.performance.path' => 'string',
            'logging.channels.performance.level' => 'string',
            'logging.channels.performance.days' => 'integer',
            'logging.channels.performance.replace_placeholders' => 'boolean',
            'logging.channels.errors.driver' => 'string',
            'logging.channels.errors.path' => 'string',
            'logging.channels.errors.level' => 'string',
            'logging.channels.errors.days' => 'integer',
            'logging.channels.errors.replace_placeholders' => 'boolean',
            'mail.default' => 'string',
...
'filament.system_route_prefix','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root','filesystems.disks.local.serve',
...
'ide-helper.enforce_nullable_relationships','ide-helper.post_migrate','ide-helper.macroable_traits','livewire.class_namespace','livewire.view_path',
...
'logging.channels.api.driver','logging.channels.api.path','logging.channels.api.level','logging.channels.api.days','logging.channels.api.replace_placeholders',
'logging.channels.performance.driver','logging.channels.performance.path','logging.channels.performance.level','logging.channels.performance.days','logging.channels.performance.replace_placeholders',
'logging.channels.errors.driver','logging.channels.errors.path','logging.channels.errors.level','logging.channels.errors.days','logging.channels.errors.replace_placeholders',
...
'broadcasting.connections.log.driver','broadcasting.connections.null.driver','view.paths','view.compiled','blade-heroicons.prefix',
...
'signed','throttle','verified','cors',);
        registerArgumentsSet('routes', 
'filament.exports.download','filament.imports.failed-rows.download','filament.admin.auth.login','filament.admin.auth.logout','filament.admin.auth.profile',
'filament.admin.pages.dashboard','filament.admin.resources.categories.index','filament.admin.resources.categories.create','filament.admin.resources.categories.edit','filament.admin.resources.orders.index',
'filament.admin.resources.orders.create','filament.admin.resources.orders.edit','filament.admin.resources.pages.index','filament.admin.resources.pages.create','filament.admin.resources.pages.edit',
'filament.admin.resources.products.index','filament.admin.resources.products.create','filament.admin.resources.products.edit','filament.admin.resources.promo-codes.index','filament.admin.resources.promo-codes.create',
'filament.admin.resources.promo-codes.edit','filament.admin.resources.topics.index','filament.admin.resources.topics.create','filament.admin.resources.topics.edit','filament.admin.resources.users.index',
'filament.admin.resources.users.create','filament.admin.resources.users.edit','scribe','scribe.postman','scribe.openapi',
'sanctum.csrf-cookie','telescope',
'livewire.update','livewire.upload-file','livewire.preview-file','api.v1.health','api.v1.auth.register',
'api.v1.auth.login','api.v1.auth.forgot-password','api.v1.auth.reset-password','api.v1.auth.logout','api.v1.auth.change-password',
'api.v1.categories.index','api.v1.categories.show','api.v1.products.show','api.v1.products.index','mail.test',
'pages.index','pages.show','api.v1.order.calculate','api.v1.order.store','api.v1.orders.index',
'user.profile','user.profile.update','user.topics.index','user.topics.show','storage.local',);
        registerArgumentsSet('views', 
'components.filament.user-menu-header','emails.auth.reset-password','emails.test','filament.components.user-name','scribe.index',
...
'validation.uuid','validation.custom.attribute-name.rule-name','filament-actions.modal.requires_confirmation_subheading','filament-actions.edit.single.label','filament-actions.edit.single.modal.heading',
'filament-actions.edit.single.modal.actions.save.label','filament-actions.edit.single.messages.saved','filament-actions.view.single.label','filament-actions.view.single.modal.heading','filament-actions.delete.single.label',
'filament-actions.delete.single.modal.heading','filament-actions.delete.single.modal.subheading','filament-actions.delete.single.modal.actions.delete.label','filament-actions.delete.single.messages.deleted','filament-actions.delete.multiple.label',
'filament-actions.delete.multiple.modal.heading','filament-actions.delete.multiple.modal.subheading','filament-actions.delete.multiple.modal.actions.delete.label','filament-actions.delete.multiple.messages.deleted','filament-actions.force_delete.single.label',
'filament-actions.force_delete.single.modal.heading','filament-actions.force_delete.single.modal.subheading','filament-actions.force_delete.single.modal.actions.force_delete.label','filament-actions.force_delete.single.messages.deleted','filament-actions.force_delete.multiple.label',
'filament-actions.force_delete.multiple.modal.heading','filament-actions.force_delete.multiple.modal.subheading','filament-actions.force_delete.multiple.modal.actions.force_delete.label','filament-actions.force_delete.multiple.messages.deleted','filament-actions.restore.single.label',
'filament-actions.restore.single.modal.heading','filament-actions.restore.single.modal.subheading','filament-actions.restore.single.modal.actions.restore.label','filament-actions.restore.single.messages.restored','filament-actions.restore.multiple.label',
'filament-actions.restore.multiple.modal.heading','filament-actions.restore.multiple.modal.subheading','filament-actions.restore.multiple.modal.actions.restore.label','filament-actions.restore.multiple.messages.restored','filament-actions.filter.label',
'filament-actions.filter.modal.heading','filament-actions.filter.modal.actions.apply.label','filament-actions.filter.modal.actions.reset.label','filament-panels.pages.dashboard.title','filament-panels.layout.sidebar.groups.users',
'filament-panels.layout.sidebar.groups.settings','filament-panels.layout.user-menu.profile.label','filament-panels.layout.user-menu.logout.label','filament-panels.actions.create.label','filament-panels.actions.edit.label',
'filament-panels.actions.delete.label','filament-panels.actions.save.label','filament-panels.actions.cancel.label','filament-panels.resources.pages.create.buttons.create.label','filament-panels.resources.pages.create.messages.created',
'filament-panels.resources.pages.edit.buttons.save.label','filament-panels.resources.pages.edit.messages.saved','filament-panels.widgets.account.label','filament-panels.navigation.group.label','filament.pages.edit.title',
'filament.pages.create.title','filament.pages.list.title','filament.components.pagination.showing_results','filament.components.pagination.results_per_page','filament.actions.edit.label',
'filament.actions.create.label','filament.actions.delete.label','filament.actions.save.label','filament.actions.cancel.label','filament.table.actions.label',
'filament.table.bulk_actions.label','filament.forms.actions.save.label','filament.forms.actions.cancel.label','filament.forms.fields.meta_title.label','filament.forms.fields.meta_description.label',
'filament.forms.fields.url.label','filament.forms.fields.url.helper_text','filament.resources.product.navigation_group','filament.resources.product.navigation_label','filament.resources.product.model_label',
'filament.resources.product.plural_model_label','filament.resources.category.navigation_group','filament.resources.category.navigation_label','filament.resources.category.model_label','filament.resources.category.plural_model_label',
'filament.resources.user.navigation_group','filament.resources.user.navigation_label','filament.resources.user.model_label','filament.resources.user.plural_model_label','validation.attributes.email',
'validation.attributes.password','validation.attributes.first_name','validation.attributes.last_name','validation.attributes.middle_name','validation.attributes.phone',
'validation.attributes.country','validation.attributes.region','validation.attributes.city','validation.attributes.postal_code','validation.attributes.address',
...
'filament-tables::table.sorting.fields.direction.options.desc','scribe::scribe.0',);
...
'MAIL_LOG_CHANNEL','AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION','AWS_BUCKET',
'AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','TELESCOPE_ENABLED','TELESCOPE_DRIVER','TELESCOPE_PATH',
'TELESCOPE_CACHE_WATCHER','TELESCOPE_COMMAND_WATCHER','TELESCOPE_DUMP_WATCHER','TELESCOPE_EVENT_WATCHER','TELESCOPE_EXCEPTION_WATCHER',
'TELESCOPE_JOB_WATCHER','TELESCOPE_LOG_WATCHER','TELESCOPE_MAIL_WATCHER','TELESCOPE_MODEL_WATCHER','TELESCOPE_NOTIFICATION_WATCHER',
'TELESCOPE_QUERY_WATCHER','TELESCOPE_REDIS_WATCHER','TELESCOPE_REQUEST_WATCHER','TELESCOPE_SCHEDULE_WATCHER','TELESCOPE_VIEW_WATCHER',
'TELESCOPE_DB_CONNECTION','L5_SWAGGER_GENERATE_ALWAYS',);
