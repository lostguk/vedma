...
'l5-swagger.defaults.scanOptions.exclude','l5-swagger.defaults.scanOptions.open_api_spec_version','l5-swagger.defaults.securityDefinitions.securitySchemes.bearerAuth.type','l5-swagger.defaults.securityDefinitions.securitySchemes.bearerAuth.scheme','l5-swagger.defaults.securityDefinitions.securitySchemes.bearerAuth.bearerFormat',
'l5-swagger.defaults.securityDefinitions.security.0.bearerAuth','l5-swagger.defaults.generate_always','l5-swagger.defaults.generate_yaml_copy','l5-swagger.defaults.proxy','l5-swagger.defaults.additional_config_url',
...
'l5-swagger.defaults.ui.display.request_snippets','l5-swagger.defaults.ui.authorization.persist_authorization','l5-swagger.defaults.ui.authorization.oauth2.use_pkce_with_authorization_code_grant','l5-swagger.defaults.constants.L5_SWAGGER_CONST_HOST','livewire.class_namespace',
...
'filament.livewire_loading_delay','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'filament-actions.filter.modal.heading','filament-actions.filter.modal.actions.apply.label','filament-actions.filter.modal.actions.reset.label','filament-panels.pages.dashboard.title','filament-panels.resources.pages.create.buttons.create.label',
'filament-panels.resources.pages.create.messages.created','filament-panels.resources.pages.edit.buttons.save.label','filament-panels.resources.pages.edit.messages.saved','filament-panels.widgets.account.label','filament-panels.navigation.group.label',
'filament.pages.edit.title','filament.pages.create.title','filament.pages.list.title','filament.components.pagination.showing_results','filament.components.pagination.results_per_page',
'filament.actions.edit.label','filament.actions.create.label','filament.actions.delete.label','filament.actions.save.label','filament.actions.cancel.label',
'filament.table.actions.label','filament.table.bulk_actions.label','filament.forms.actions.save.label','filament.forms.actions.cancel.label','filament-actions::associate.single.label',
