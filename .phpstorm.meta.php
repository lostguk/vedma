...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'l5-swagger.defaults.securityDefinitions.securitySchemes.bearerAuth.type' => 'string',
            'l5-swagger.defaults.securityDefinitions.securitySchemes.bearerAuth.scheme' => 'string',
            'l5-swagger.defaults.securityDefinitions.securitySchemes.bearerAuth.bearerFormat' => 'string',
            'l5-swagger.defaults.securityDefinitions.security.0.bearerAuth' => 'array',
            ...
            'l5-swagger.defaults.operations_sort' => 'string',
            ...
            'l5-swagger.defaults.ui.display.request_snippets' => 'boolean',
...
'ide-helper.post_migrate','ide-helper.macroable_traits','l5-swagger.default','l5-swagger.documentations.default.api.title','l5-swagger.documentations.default.routes.api',
...
'l5-swagger.defaults.scanOptions.processors','l5-swagger.defaults.scanOptions.pattern','l5-swagger.defaults.scanOptions.exclude','l5-swagger.defaults.scanOptions.open_api_spec_version','l5-swagger.defaults.securityDefinitions.securitySchemes.bearerAuth.type',
'l5-swagger.defaults.securityDefinitions.securitySchemes.bearerAuth.scheme','l5-swagger.defaults.securityDefinitions.securitySchemes.bearerAuth.bearerFormat','l5-swagger.defaults.securityDefinitions.security.0.bearerAuth','l5-swagger.defaults.generate_always','l5-swagger.defaults.generate_yaml_copy',
...
'l5-swagger.defaults.ui.display.doc_expansion','l5-swagger.defaults.ui.display.filter','l5-swagger.defaults.ui.display.request_snippets','l5-swagger.defaults.ui.authorization.persist_authorization','l5-swagger.defaults.ui.authorization.oauth2.use_pkce_with_authorization_code_grant',
'l5-swagger.defaults.constants.L5_SWAGGER_CONST_HOST','livewire.class_namespace','livewire.view_path','livewire.layout','livewire.lazy_placeholder',
...
'broadcasting.connections.null.driver','view.paths','view.compiled','blade-heroicons.prefix','blade-heroicons.fallback',
'blade-heroicons.class','blade-heroicons.attributes','blade-icons.sets','blade-icons.class','blade-icons.attributes',
'blade-icons.fallback','blade-icons.components.disabled','blade-icons.components.default','tinker.commands','tinker.alias',
'tinker.dont_alias',);
...
'l5-swagger.default.api','l5-swagger.default.docs','l5-swagger.default.asset','l5-swagger.default.oauth2_callback','filament.exports.download',
'filament.imports.failed-rows.download','filament.admin.auth.login','filament.admin.auth.logout','filament.admin.auth.profile','filament.admin.pages.dashboard',
'filament.admin.resources.categories.index','filament.admin.resources.categories.create','filament.admin.resources.categories.edit','filament.admin.resources.products.index','filament.admin.resources.products.create',
'filament.admin.resources.products.edit','filament.admin.resources.users.index','filament.admin.resources.users.create','filament.admin.resources.users.edit','sanctum.csrf-cookie','telescope','livewire.update','livewire.upload-file','livewire.preview-file','api.v1.auth.register','api.v1.categories.index','api.v1.categories.show','storage.local',);
        registerArgumentsSet('views', 
'components.filament.user-menu-header','filament.components.user-name','l5-swagger::index','livewire.counter','vendor.l5-swagger.index',
...
'TELESCOPE_SCHEDULE_WATCHER','TELESCOPE_VIEW_WATCHER',);
