...
Слайдер на главной странице магазина. Каждый слайд содержит заголовок, акцент, подзаголовок, кнопку и фоновое изображение. Управляется через Filament-админку с drag&drop сортировкой.
...
- Функции:
  ...
  - Drag&drop сортировка (reorderable по `sort_order`)
