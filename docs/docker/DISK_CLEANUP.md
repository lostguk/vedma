...
### 1. Автоматическая очистка через cron
...
### 2. Настройка Docker daemon для ограничения размера
...
### 4. Оптимизация docker-compose для production
